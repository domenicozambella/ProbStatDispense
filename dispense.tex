...
Nell'a.a.2022/23 questo paragrafo non è programma d'esame.
...
Si verifica che (approssimativamente) 

\ceq{\hfill\frac{B_0-\beta_0}{S_0/\sqrt{n}}}{\sim}{{\rm T}(n-2)}


\ceq{\hfill\frac{B_1-\beta_1}{S_1/\sqrt{n}}}{\sim}{{\rm T}(n-2)}
